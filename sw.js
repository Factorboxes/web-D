...
const CACHE_NAME=CACHE_PREFIX+'paperdisplay10';
const SHELL='./index.html';
const FILES=[SHELL,'./styles.css?v=20260910-paperdisplay10','./app.js?v=20260910-paperdisplay10','./math.mjs?v=20260910-paperdisplay10','./pwa.js?v=20260909-pwa5','./manifest.webmanifest?v=rainbow6','./thai-regular.woff','./thai-bold.woff','./icon-192.png?v=rainbow6','./icon-512.png?v=rainbow6','./apple-touch-icon.png?v=rainbow6','./icon-maskable.png?v=rainbow6'];
